...
public class ProfileResourceInMemoryTest {
    ...
    private final String country = "Norway";
    ...
    public void T05_getProfile() throws Exception {
        ...
        assertThat(resp.getStatus()).isEqualTo(Response.Status.OK.getStatusCode());
        assertThat(resp.getMediaType().toString()).isEqualTo(MediaType.APPLICATION_JSON);
        assertThat(resp.readEntity(Subscriber.class)).isEqualTo(getCheckProfile(name, newAddress,
                newPostCode, city, email, country));
    }

    private Subscriber getCheckProfile() {
        return getCheckProfile(name, address, postCode, city, email, country);
    }

    private Subscriber getCheckProfile(final String name, final String address, final String postCode,
                                       final String city, final String email, final String country) {
