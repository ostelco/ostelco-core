...
@JsonTypeName("embedded-neo4j")
class EmbeddedNeo4jModule : PrimeModule {
...
private fun initDatabase() {
    ...
    EmbeddedNeo4jStoreSingleton.addSubscriber(Subscriber(email = "foo@bar.com", name = "Test User"))
    EmbeddedNeo4jStoreSingleton.addSubscription("foo@bar.com", "4747900184")
    EmbeddedNeo4jStoreSingleton.setBalance("4747900184", 1_000_000_000L)
...
object GraphServer : Managed, HealthCheck() {
    ...
    override fun start() {
        ...
        graphDb = GraphDatabaseFactory()
                .newEmbeddedDatabaseBuilder(File(ConfigRegistry.config.path))
